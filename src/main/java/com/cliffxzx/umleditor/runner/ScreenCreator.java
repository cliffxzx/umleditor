 ...
 * This creates a <code>Screen</code> on demand with instances of the model,
 * view and controller.
 *
 * @param <ModelClass>      the class of the model, eg
 *                          <code>core.Model.class</code>
 * @param <ViewClass>       the class of the view, eg
 *                          <code>core.View.class</code>
 * @param <ControllerClass> the class of the core.Controller, eg
 *                          <code>core.Controller.class</code>
 */
public class ScreenCreator<ModelClass extends Class<? extends Model>, ViewClass extends Class<? extends View>, ControllerClass extends Class<? extends Controller>> {
    ...
    public Screen create() {
        try {
            ...
            Controller controller = controllerClass.getDeclaredConstructor(new Class[] { View.class, Model.class })
