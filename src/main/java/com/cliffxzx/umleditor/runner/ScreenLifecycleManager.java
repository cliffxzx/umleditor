...
public class ScreenLifecycleManager {
     ...
     * @param metadata any data that should be passed to the screen's
     *                 <code>Model</code>.
     */
    public void switchTo(Screen screen, Object metadata) {
        ScreenLifecycle createdScreenLifecycle = new ScreenLifecycle(screen,
                new Navigator(this, ScreenRegistry.getInstance()));
