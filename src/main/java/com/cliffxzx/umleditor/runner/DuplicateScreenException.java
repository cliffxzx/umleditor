...
/**
 * This exception is called when two Models, two Views, or two Controllers have
 * the same @MVC() annotation.
...
public class DuplicateScreenException extends RuntimeException {
    ...
    protected DuplicateScreenException(String message, Throwable cause, boolean enableSuppression,
